...
* **The Heatmap:** By assigning a high score (100) to the goal and a penalty (-1) to the lava, the "value" of the goal slowly spreads backward across the map over time. The green path on the heatmap isn't a hardcoded route—it emerges naturally as the agent follows the highest values it remembers.
